...
async function scrapeHigherinJobs() {
  const { browser, page } = await startBrowser();

  await page.goto("https://higherin.com/jobs", {
    waitUntil: "domcontentloaded",
  });

  const jobLinks = await page.evaluate(() =>
    Array.from(document.querySelectorAll("a.job-card")).map((a) => a.href)
  );
...
module.exports = { scrapeHigherinJobs };
